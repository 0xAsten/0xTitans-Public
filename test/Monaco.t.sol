...
import {SwiftRacerCar} from "../src/cars/SwiftRacerCar.sol";
...
contract MonacoTest is Test {
    ...
    function testGames() public {
        ...
        vm.writeFile("logs/cars.csv", "address,car\n");
        vm.writeLine(
            "logs/cars.csv",
            string.concat(vm.toString(address(w1)), ",", "Car1")
        );
        vm.writeLine(
            "logs/cars.csv",
            string.concat(vm.toString(address(w2)), ",", "Car2")
        );
        vm.writeLine(
            "logs/cars.csv",
            string.concat(vm.toString(address(w3)), ",", "Car3")
        );
